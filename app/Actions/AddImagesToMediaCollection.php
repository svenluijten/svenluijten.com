...
class AddImagesToMediaCollection
{
    ...
    public function execute(string $contents, HasMedia $model, string $collectionName): void
    {
        ...
        foreach ($matches as $match) {
            ...
            $imageFullPath = storage_path('old-content/images/concerts/'.basename($imagePath));
