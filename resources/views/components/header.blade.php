...
<header class="container font-system">
    <div class="mx-auto w-full flex flex-row items-center justify-between py-2 px-2 | lg:w-2/3 lg:px-0 md:py-4">
        <a href="/" class="group">
            <img src="/images/logo.svg" alt="Sven Luijten" class="w-16 h-16 group-hover:scale-105 group-hover:rotate-6 transition-all duration-75">
        </a>
        ...
        <nav>
            <ul class="flex justify-center text-lg">
                ...
                <li class="px-2 | lg:px-4">
                    <a href="/explore" class="underline-offset-2 hover:underline">
                        Explore
                    </a>
                </li>
            </ul>
