...
{{--
    ...
    you scroll (see layout). When a link here has keyboard focus it's lifted
    above the paper, so focus is never hidden underneath the sheet.
--}}
<header @class(['sticky top-0 | has-focus-visible:z-10 has-focus-visible:bg-tertiary' => $sticky])>
